...
public class Master_Barang extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnBarcode.setMaximumSize(new java.awt.Dimension(69, 22));
        btnBarcode.setMinimumSize(new java.awt.Dimension(69, 22));
        btnBarcode.setPreferredSize(new java.awt.Dimension(95, 29));
        ...
        cbxSatuan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Jenis Satuan -", "Pcs" }));
    ...
    private void btnBarcodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBarcodeActionPerformed
        ...
        if (selectedRow != -1) {
            ...
            String id = (String) tblData.getValueAt(selectedRow, 1);
            new BARCODE(id).setVisible(true);
        } else {
            JOptionPane.showMessageDialog(null, "Pilih baris terlebih dahulu", "Warning", JOptionPane.YES_OPTION);
        }
